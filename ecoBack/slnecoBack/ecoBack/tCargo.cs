...
namespace ecoBack
{
    ...
    {
        public int fCargoId { get; set; }
        public string fShipCompany { get; set; }
        public string fSender { get; set; }
        public string fUserId { get; set; }
        public string fCargoType { get; set; }
        public Nullable<System.DateTime> fArriveDate { get; set; }
        public Nullable<int> fReceiveOrNot { get; set; }
        public string fSignaturePath { get; set; }
